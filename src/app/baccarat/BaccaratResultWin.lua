...
local BaccaratResultWin = class("BaccaratResultWin", WinBase)

function BaccaratResultWin:ctor(playerPoint, bankerPoint, total)
    BaccaratResultWin.super.ctor(self)
    self.playerPoint = playerPoint or 0
    self.bankerPoint = bankerPoint or 0
    self.total = total or 0
end

function BaccaratResultWin:onWinEnter()
